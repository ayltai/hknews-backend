...
public final class AppleDailyParserTest extends ParserTest {
    ...
    public void testGetItems() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/appledaily_list.html"), StandardCharsets.UTF_8)) {
            try (BufferedReader bufferedReader = new BufferedReader(inputStreamReader)) {
                ...
                final Collection<Item> items = new AppleDailyParser(factory, this.sourceRepository).getItems(new Category(Collections.singletonList("https://hk.appledaily.com/video/videolist/20180918/local/home/0"), "即時港聞"));
    ...
    public void testGetItem() throws IOException {
        ...
        final Item updatedItem = new AppleDailyParser(factory, this.sourceRepository).getItem(item);
