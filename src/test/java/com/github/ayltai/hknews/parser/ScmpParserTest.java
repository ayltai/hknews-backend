...
public final class ScmpParserTest extends ParserTest {
    ...
    public void testGetItem() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("scmp.html"), StandardCharsets.UTF_8)) {
            try (BufferedReader bufferedReader = new BufferedReader(inputStreamReader)) {
                ...
                Assert.assertEquals("Incorrect image URL", "https://cdn4.i-scmp.com/sites/default/files/styles/980w/public/images/methode/2018/07/25/d337d59c-8fb3-11e8-ad1d-4615aa6bc452_1280x720_145921.jpg?itok=gREruORo", updatedItem.getImages().get(0).getImageUrl());
                Assert.assertEquals("Incorrect video count", 1, updatedItem.getVideos().size());
                Assert.assertEquals("Incorrect video URL", "https://cf.cdn.vid.ly/5o6g9f/mp4.mp4", updatedItem.getVideos().get(0).getVideoUrl());
